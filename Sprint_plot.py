...
# restringo la lista, prendendo l'indice del primo valore di datax a noi lecito e l'indice successivo al'ultimo
# valore lecito di datax, perche' il range funziona cosi
